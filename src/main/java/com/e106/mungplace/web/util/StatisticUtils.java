...
public class StatisticUtils {
    ...
    public static ExplorationStatisticResponse createExplorationStatisticOfMonth(int year, int month, List<ExplorationResponse> explorations) {
    ...
    private static Map<LocalDate, Long> generateDailyTimeMap(List<ExplorationResponse> explorations) {
        return explorations.stream()
                ...
                .collect(Collectors.groupingBy(
                        ...
                        Collectors.summingLong(exploration -> Duration.between(exploration.startTime(), exploration.endTime()).toSeconds())
                )
        );
    }
